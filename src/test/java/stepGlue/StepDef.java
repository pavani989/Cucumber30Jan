...
public class StepDef {
	...
	@When("Alex return the faulity microwave")
	public void alex_return_the_faulity_microwave() {
	    // Write code here that turns the phrase above into concrete actions
	   // throw new cucumber.api.PendingException();
		System.out.println("Alex return the faulity microwave");
	}
	...
	@Then("Alex get Registratin Success")
	public void alex_get_Registratin_Success() {
	    // Write code here that turns the phrase above into concrete actions
	   // throw new cucumber.api.PendingException();
	}
